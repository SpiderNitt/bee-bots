...
float rpm_1,rpm_2;                                   
float PID1 = 0 , PID2 = 0 ;
float  set_speed1 =90.0 ,set_speed2 = 90.0; 
...
{ 
  ...
  DDRC &=~(1<<0)|(1<<1);          // INPUT PINS TO DRIVE THE BOT ON DIFFERENT MODES
...
// for testing :
// check forward backward left right motions independently
// check set speed
// check with input port pins
// successful
