...
float get_object_position(int Coordinate)                     //returns the absolute position of the bot
{
	 simxGetObjectPosition(ID,*eBot,-1,pos,simx_opmode_streaming);
	 if(Coordinate==0)
	     return pos[0];
	 if(Coordinate==1)
	     return pos[1];
